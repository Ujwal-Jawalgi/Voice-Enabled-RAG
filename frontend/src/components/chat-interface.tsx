            ...
            <div className="mt-4 pt-6 border-t border-border grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm font-mono text-zinc-600 dark:text-zinc-400">
                  ...
                  <div className="flex justify-between"><span>Embedding:</span> <span>{(response.timings_ms.embedding?? 0*0.1).toFixed(1)} ms</span></div>
                  <div className="flex justify-between"><span>Retrieval (FAISS):</span> <span>{(response.timings_ms.retrieval * 0.1).toFixed(1)} ms</span></div>
